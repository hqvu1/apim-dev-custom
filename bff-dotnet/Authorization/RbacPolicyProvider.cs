...
public sealed class RbacPolicyProvider
{
    private readonly IOptionsMonitor<RbacConfig> _config;
    private readonly ILogger<RbacPolicyProvider> _logger;

    public RbacPolicyProvider(IOptionsMonitor<RbacConfig> config, ILogger<RbacPolicyProvider> logger)
    {
        _config = config;
        _logger = logger;
    }
