...
public static class UserEndpoints
{
    public static RouteGroupBuilder MapUserEndpoints(this WebApplication app)
    {
        ...
        // GET /users/me/subscriptions — alias for /subscriptions scoped to current user
        // SPA MyIntegrations.tsx calls this path instead of /subscriptions
        group.MapGet("/me/subscriptions", async (
            int? top, int? skip,
        ...
        .WithSummary("List current user's subscriptions (alias for /subscriptions)")
