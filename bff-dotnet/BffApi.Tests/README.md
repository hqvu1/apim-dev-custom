# BffApi.Tests — Test Project Documentation

> **Project:** `BffApi.Tests`
> **Target:** .NET 10 · xUnit 2.9 · NSubstitute 5.3
> **SUT:** `BffApi` (ASP.NET Core Minimal API)
...
# Run all tests
cd bff-dotnet
dotnet test BffApi.Tests/BffApi.Tests.csproj

# Run a specific test class
dotnet test --filter "FullyQualifiedName~RbacPolicyProviderTests"

# Run with verbose output
dotnet test BffApi.Tests/BffApi.Tests.csproj -v n
```
