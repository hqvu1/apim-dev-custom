<<<<<<<< HEAD:docs/KOMATSU_APIM_INTEGRATION_GUIDE.md
...
========
# Komatsu custom APIM Customization Framework - Integration Preparation Guide

## Overview

This guide outlines all necessary preparations to integrate the Komatsu API Marketplace Portal with the **Komatsu custom APIM Customization Framework** for Azure API Management.
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
- **Backend API service** to interface with Komatsu custom APIM
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
Create a Backend-for-Frontend service that interfaces with the Komatsu custom APIM Customization Framework.
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
│   │   ├── apim.service.ts      # Komatsu custom APIM client
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
### Option B: Use Komatsu custom APIM REST APIs Directly

If the Komatsu custom framework provides direct REST APIs, you can call them from the frontend with proper CORS configuration.
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
# Komatsu custom APIM Configuration
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
## 5. Komatsu custom APIM Framework Integration Points

### Required Documentation from Komatsu custom

Request the following from your Komatsu custom team:
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
### Sample Integration Questions for Komatsu custom
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
- [ ] Obtain Komatsu custom APIM framework documentation
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
1. Connect backend to Komatsu custom APIM framework
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
...
========
1. **Schedule meeting with Komatsu custom team** to review their APIM Customization Framework
>>>>>>>> walk-back:docs/CUSTOM_APIM_INTEGRATION_GUIDE.md
