# Third Party APIM Customization Framework - Integration Preparation Guide

## Overview

This guide outlines all necessary preparations to integrate the Komatsu API Marketplace Portal with the **Third Party APIM Customization Framework** for Azure API Management.
...
### ❌ What's Missing
- **Backend API service** to interface with Third Party APIM
...
Create a Backend-for-Frontend service that interfaces with the Third Party APIM Customization Framework.
...
│   │   └── analytics.routes.ts
│   ├── services/
│   │   ├── apim.service.ts      # Third Party APIM client
...
### Option B: Use Third Party APIM REST APIs Directly

If the Third Party framework provides direct REST APIs, you can call them from the frontend with proper CORS configuration.
...
```env
# Third Party APIM Configuration
...
## 5. Third Party APIM Framework Integration Points

### Required Documentation from Third Party

Request the following from your Third Party team:
...
### Sample Integration Questions for Third Party
...
### Pre-Deployment
- [ ] Obtain Third Party APIM framework documentation
...
1. Connect backend to Third Party APIM framework
...
1. **Schedule meeting with Third Party team** to review their APIM Customization Framework
